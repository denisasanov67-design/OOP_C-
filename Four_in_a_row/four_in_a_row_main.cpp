...
void playGame() {
    ...
    vector<int>* moveHistory = new vector<int>();

    while (!field->isOver()) {
        field->print();
        cout << "Turn: " << (field->isRedTurnNow() ? "Red" : "Yellow") << endl;
        cout << "Column (1-7, 0 - exit, -1 - undo): ";
